...
-- Lista de actores y las películas en las que participaron
SELECT 
...
-- Películas lanzadas antes del año 2000
SELECT *FROM MOVIE WHERE year < 2000;

-- Película lanzadas después del añoo 2000
SELECT *FROM MOVIE WHERE year >= 2000;


-- Lista de los actores que hayan aparecido en más de una película registrada en la base de datos
SELECT 
    a.name AS actor_name,
